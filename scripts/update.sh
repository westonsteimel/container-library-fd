...
version=`curl --silent "https://api.github.com/repos/sharkdp/fd/releases/latest" | jq .tag_name | xargs`
revision=`curl --silent "https://api.github.com/repos/sharkdp/fd/commits/${version}" | jq .sha | xargs`
version=${version#"v"}
